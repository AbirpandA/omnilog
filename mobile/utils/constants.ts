import { ThumbsDown, Meh, Sparkles, Star, Bookmark, FolderHeart } from 'lucide-react-native';

export type ReactionType = 'lame' | 'okay' | 'pure gold' | 'Absolute cinema' | 'watchlist' | 'collection';

export const ReactionConfig: Record<ReactionType, { icon: React.ElementType, color: string, label: string }> = {
